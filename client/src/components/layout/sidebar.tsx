...
import { BarChart3, Package, FlaskRound, Truck, Tag, FileText, Plus, CreditCard, HelpCircle } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navigation = [
    ...
    { name: "Support & Help", href: "/support", icon: HelpCircle, count: null },
  ];
